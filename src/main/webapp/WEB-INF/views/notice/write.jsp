...
<body>
    ...
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/notice/write" method="post">
            ...
            <div class="form-group">
                <label for="writer">작성자 (관리자)</label>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" id="isUrgent" name="isUrgent" value="Y"> 긴급 공지로 표시
            </div>
            
            <div class="form-actions">
                <button type="submit" class="btn-submit">등록하기</button>
                <a href="${pageContext.request.contextPath}/notice/list" class="btn-cancel">목록으로</a>
            </div>
        </form>
    </div>
